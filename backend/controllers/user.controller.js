    ...
    userPromise
        .then(() => {
            ...
            const mailConfigurations = {
                from: 'mbaliqwema94@gmail.com',
                to: req.body.email,
                subject: 'Email Verification',
                // This would be the text of email body
                text: `WELCOME TO TOOL KONNECT, APLATFORM OF CONVINIENCE`
            };
...
exports.findAll = (req, res) => {
    ...
    User.find(condition)
        ...
        .catch((err) => {
            res.status(500).send({
                message:
                    err.message || "Some error occurred while retrieving all the users.",
            });
        });
};
...
exports.signIn = (req, res) => {
    ...
    User.findOne({
        ...
        .then((user) => {
            ...
            let pass = brycypt.compareSync(req.body.password, dbPass);
